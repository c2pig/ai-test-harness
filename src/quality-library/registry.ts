import { QualityAttributeDefinition, ValidationResult } from './types';
 ...
 * @returns ValidationResult with invalid attributes
 */
export async function validateAttributeNames(attributeNames: string[]): Promise<ValidationResult> {
